...
#include "../scoped/scoped_ptr.hpp"
#include "../scoped/scoped_lock.hpp"
...
#define METRICS_INT64_MAX 9223372036854775807LL
#define METRICS_INT64_MIN (-METRICS_INT64_MAX - 1)
...
public:
  ...
  public:
    ...
    void get_snapshot(Snapshot* snapshot, bool reset) const {
      ...
      snapshot->percentile_90th = hdr_value_at_percentile(h, 90.0);
  ...
  private:
    ...
    public:
      WriterReaderPhaser()
        : start_epoch_(0)
        , even_end_epoch_(0)
        , odd_end_epoch_(METRICS_INT64_MIN) {}
      ...
      void flip_phase() {
        ...
        if (is_next_phase_even) {
          ...
          initial_start_value = METRICS_INT64_MIN;
